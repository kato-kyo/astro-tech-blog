...
export const SITE_CONFIG = {
  ...
  blog: {
    // ブログ一覧ページの説明文
    description:
      '技術記事の一覧ページです。プログラミング、Web開発、インフラなどの記事を公開日順に表示しています。',
    // ブログ一覧ページのサブタイトル
    subtitle: '技術に関する記事や学習記録を公開しています',
  },
  ...
  tags: {
    // タグ一覧ページの説明文
    description:
      'ブログで使用されているタグの一覧ページです。興味のあるタグから記事を探すことができます。',
    // タグ一覧ページのサブタイトル
    subtitle: 'ブログで使用されているタグから記事を探す',
  },
